  ...
  return (
    <div className="auth-transition-overlay" role="status" aria-live="polite" aria-label={message}>
      <div className="auth-transition-panel">
        <svg viewBox="0 0 44 44" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg" className="auth-transition-ripple" role="presentation" aria-hidden="true" style={{ color: '#366cf3' }}>
